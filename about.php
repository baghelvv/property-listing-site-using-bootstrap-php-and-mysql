        ...
        <div class="menu-bg-wrap">
          <div class="site-navigation">
            ...
            >
              ...
              <li><a href="#">Saved Property</a></li>
              <li class="has-children">
              
                <!-- <a href="properties.php">Properties</a> --> <li class="nav-item dropdown ">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small text-profile">Howdy,'; echo $_SESSION['use']; echo'</span>
                <img class="img-profile rounded-circle" src="https://impulse.aarafacademy.com/uploads/samples/g1.jpg" alt="Profile Image" style="width: 40px; height: 40px;">
              ...
              <li><a href="contact.php">Contact Us</a></li>
                <!-- <a href="properties.php">Properties</a> --> <li class="nav-item dropdown ">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small text-profile"></span>
                <img class="img-profile rounded-circle" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnI75pAjlZIB-WsV_RwjU_yYcy4SlpYNmuqA&usqp=CAU" alt="Profile Image" style="width: 40px; height: 40px;">
        
              </a>
             
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="login.php">Sign In/Register</a></li>
