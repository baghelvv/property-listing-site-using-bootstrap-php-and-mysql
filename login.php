...
<html lang="en">
  ...
  <body class="bg-info">
    <div class="container">
        ...
        <div class="col-lg-10 my-auto myShadow">
          <div class="row">
            <div class="col-lg-7 bg-white p-4">
              ...
              <hr class="my-3" />
              <form action="auth.php" method="post" class="px-3" id="login-form">
                ...
                <div class="form-group">
                  <input type="submit" id="login-btn" value="Sign In" class="btn btn-primary btn-lg btn-block myBtn" name="signin" />
                </div>
              </form>
            </div>
        ...
        <div class="col-lg-10 my-auto myShadow">
          <div class="row">
            ...
            <div class="col-lg-7 bg-white p-4">
              ...
              <hr class="my-3" />
              <form action="auth.php" method="post" class="px-3" id="register-form">
                <div class="input-group input-group-lg form-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text rounded-0"><i class="far fas fa-user-tie fa-lg fa-fw"></i></span>
                  </div>
                ...
                <div class="input-group input-group-lg form-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text rounded-0"><i class=" fa fa-phone fa-lg "></i></span>
                  </div>
                  <input type="number" id="remail" name="phone" class="form-control rounded-0" placeholder="Phone No."  minlength="10" minlength="12"required />
                </div>
                <div class="input-group input-group-lg form-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text rounded-0"><i class="fas fa-key fa-lg fa-fw"></i></span>
                ...
                <div class="form-group">
                  <input type="submit" id="register-btn" value="Sign Up" class="btn btn-primary btn-lg btn-block myBtn" name="signup" />
                </div>
              </form>
            </div>
          </div>
      ...
      <form action="auth.php" method="post" class="px-3" >
        ...
        <div class="col-lg-10 my-auto myShadow">
          <div class="row">
            <div class="col-lg-7 bg-white p-4">
              ...
              <form action="auth.php" method="post" class="px-3" id="forgot-form">
                ...
                <div class="form-group">
                  <input type="submit" id="forgot-btn" name="resetpwdbtn" value="Reset Password" class="btn btn-primary btn-lg btn-block myBtn" />
                </div>
              </form>
            </div>
